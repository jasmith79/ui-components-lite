...
const Input = Object(__WEBPACK_IMPORTED_MODULE_3__utils_ui_component_base_js__["b" /* defineUIComponent */])({
  ...
  template,
  reflectedAttrs,
  definition: class Input extends Object(__WEBPACK_IMPORTED_MODULE_4__node_modules_mixwith_src_mixwith_js__["a" /* mix */])(__WEBPACK_IMPORTED_MODULE_3__utils_ui_component_base_js__["a" /* UIBase */]).with(__WEBPACK_IMPORTED_MODULE_1__form_js__["a" /* FormBehavior */], __WEBPACK_IMPORTED_MODULE_2__utils_focusable_js__["a" /* default */]) {
    constructor () {
      super();
      this._input = null;
    }
...
const ListBehavior = superclass => Object(__WEBPACK_IMPORTED_MODULE_4__utils_ui_component_base_js__["b" /* defineUIComponent */])({
  ...
  registerElement: false,
  definition: class extends Object(__WEBPACK_IMPORTED_MODULE_6__node_modules_mixwith_src_mixwith_js__["a" /* mix */])(superclass).with(__WEBPACK_IMPORTED_MODULE_1__form_js__["a" /* FormBehavior */]) {
    constructor () {
      super();
      this._items = [];
      this._selected = null;
